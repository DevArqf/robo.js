...
```bash
npx robo add /path/to/@robojs/cli
```

Replace `/path/to/@robojs/cli` with the actual path to your plugin's directory. Remember to build your plugin between changes using the `robo build` command.
