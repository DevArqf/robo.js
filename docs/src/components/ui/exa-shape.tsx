...
export function ExaShape(props: ExaShapeProps) {
  const {
    accentColor = "var(--exa-accent)",
    accentLineWidth = 0,
    autoWidth = true,
    blur = true,
    children,
  ...
  const currentOuterColor = isHovering && highlight ? "var(--primary)" : outerColor
