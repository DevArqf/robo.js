...
```javascript title="/src/commands/add-points.js"
...
```typescript title="/src/commands/add-points.ts"
import { setState, getState } from 'robo.js'
...
```javascript title="/src/commands/get-points.js"
...
```typescript title="/src/commands/get-points.ts"
import { getState } from 'robo.js'
import type { CommandResult } from 'robo.js'
...
```javascript title="/src/modules/foo/commands/increment.js"
import { setState, getState } from 'robo.js'
...
```typescript title="/src/modules/foo/commands/increment.ts"
import { setState, getState } from 'robo.js'
import type { CommandResult } from 'robo.js'
...
```javascript title="/src/modules/bar/commands/bar-increment.js"
import { setState, getState } from 'robo.js'
...
```typescript title="/src/modules/bar/commands/bar-increment.ts"
import { setState, getState } from 'robo.js'
import type { CommandResult } from 'robo.js'
...
```javascript title="/src/commands/set-important-data.js"
...
```typescript title="/src/commands/set-important-data.ts"
import { setState } from 'robo.js'
import type { CommandResult } from 'robo.js'
...
```javascript title="/src/commmands/daily-challenge.js"
...
```typescript title="/src/commmands/daily-challenge.ts"
import { getState, setState } from 'robo.js'
import type { CommandResult } from 'robo.js'
