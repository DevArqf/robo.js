...
Looking to self-host? Check out the **[Self-Hosting](./self-host.mdx)** section!
...
Pods live independently from our main RoboPlay infrastructure, so rest assured that your Robos will stay up and running even if RoboPlay itself experiences downtime.
</Callout>
...
<Callout type="info" title="Sage AI">
