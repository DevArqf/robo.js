---
title: "@robojs/cron"
description: Effortlessly schedule tasks with cron expressions for Robo.js.
---
...
```javascript title="src/cron/job.js"
export default () => {
...
```javascript title="src/commands/start-job.js"
import { Cron } from '@robojs/cron'
...
<Cards>
  <Card href="https://crontab.guru/" title="Crontab Guru" description="Tool to generate cron expressions." />
...
<Cards>
  <Card href="https://github.com/Wave-Play/robo.js/tree/main/packages/@robojs/cron" title="GitHub Repository" description="Explore source code on GitHub." />
