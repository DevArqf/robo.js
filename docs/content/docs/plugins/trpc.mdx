---
title: "@robojs/trpc"
description: TypeScript-first tRPC integration for Robo.js with type-safe API layer.
---

# @robojs/trpc

Add a **[tRPC](https://trpc.io)** server and client to your Robo automatically. **tRPC** is a modern **[TypeScript](/docs/framework/typescript)**-first RPC framework for building web services. This plugin sets up a tRPC router and client in your project, allowing you to easily create and consume APIs.

You must already have **[@robojs/server](./server)** installed.

## Installation

To add this plugin to your **[Robo.js](/docs/getting-started)** project:

```bash
robo add @robojs/server @robojs/trpc
```
...
The `trpc` and `trpcQueryClient` objects can be **[seeded](/docs/plugins/seed)** for you during installation.
...
<Cards>
  <Card href="https://github.com/Wave-Play/robo.js/tree/main/packages/@robojs/trpc" title="GitHub Repository" description="Explore source code on GitHub." />
