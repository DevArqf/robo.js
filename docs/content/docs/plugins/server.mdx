---
title: "@robojs/server"
description: Create and manage web routes with file-based routing for Robo.js.
---
...
<Callout>
RoboPlay Pods are currently optimized for bots and do not support API servers. This will be supported in the coming weeks.
</Callout>
...
<Cards>
  <Card href="https://github.com/Wave-Play/robo.js/tree/main/packages/plugin-api" title="GitHub Repository" description="Explore source code on GitHub." />
