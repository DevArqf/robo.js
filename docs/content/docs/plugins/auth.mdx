---
title: "@robojs/auth"
description: Modern authentication for Robo.js projects powered by Auth.js with OAuth, email/password, and more.
---
...
Prefer Prisma over Flashcore? Swap the adapter and keep the rest of your config untouched:
...
<Callout>
Install `@auth/prisma-adapter` (and `@prisma/client`) in your project before wiring this adapter.
</Callout>

The Prisma adapter stays compatible with Auth.js' recommended schema while layering in password helpers, reset tokens, and pagination utilities.
...
<Cards>
  <Card href="https://github.com/Wave-Play/robo.js/tree/main/packages/@robojs/auth" title="GitHub Repository" description="Explore source code on GitHub." />
