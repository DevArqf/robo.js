---
title: Seeding
description: Automate plugin file setup with seed functionality in Robo.js.
---
...
When you install a plugin with the **[Robo CLI](/docs/framework/cli)**, you may be asked if you want files included and a description of them.
...
Seeds are smart enough to detect if you're using **[TypeScript](/docs/framework/typescript)** and seed `.ts` files instead of `.js`.
...
<Cards>
	<Card href="/docs/framework/typescript" title="TypeScript" description="Write better code with type safety." />
</Cards>
...
When the user **[installs your plugin](/docs/framework/plugins/install)**, these files are copied to their project if they approve.

While optional, a description of the files is recommended to help users understand what they are getting. You can provide a description in your plugin's **[Robo Config](/docs/framework/config)** file:
