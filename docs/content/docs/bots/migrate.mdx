...
1. Migrate your bot to the [Robo.js File Structure](./file-structure.mdx).
...
```js title="/src/events/_start.js" showLineNumbers {4-6}
...
By doing this, you'll enjoy most of Robo.js features while gradually migrating your handlers (events/commands) to the [Robo.js File Structure](./file-structure.mdx).

<Callout type="info" title="Client Login">
...
With this setup, you can start migrating your existing commands into the [Robo.js File Structure](./file-structure.mdx) or create new ones this way while you work your way there.
...
## Why We're All About the Robo.js File Structure
...
<Callout type="info">
It's not required, but **TypeScript + Linting** while you're working with Robo.js can be super handy. Check out the [TypeScript Docs](../framework/core/typescript.mdx) and [Linting Docs](../framework/core/linting.mdx) to get started.
</Callout>
